...
set :linked_files, %w{config/database.yml config/initializers/illbackend_cfg.rb db/seeds/locations.rb db/seeds/testdata.rb db/seeds/users.rb}

set :rvm_ruby_version, "2.1.1"              # use the same ruby as used locally for deployment
